...
namespace SyZero.Common
{
    ...
    public class JsonHelper
    {
        ...
        /// </summary> 
        /// <param name="obj">对象</param> 
        /// <returns>Layui JSON格式的字符串</returns> 
        public static string toLayuiTable(int code,string msg,int count,object obj)
        {
            try
            {
                ...
                layJson.count = count;
                layJson.data = obj;
                byte[] b = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(layJson));
                return Encoding.UTF8.GetString(b);
            }
            catch (Exception ex)
            {
        ...
        public static string toLayuiMsg(string msg, object obj = null)
        {
            try
            {
                LayJson layJson = new LayJson();
